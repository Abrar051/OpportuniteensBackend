...
<input class="form-control" placeholder="Computer, Biology, Physics, Math, Stem" name="type" required type="text"> 
</div>
...
<button  onclick="return val();" type="submit" name="reg_mode" class="btn btn-success">Register</button>
</div>
